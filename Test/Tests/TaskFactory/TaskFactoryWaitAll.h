...
TEST(TaskFactoryTestWaitAll, wait_multiple_tasks)
{
    ...
    ASSERT_NO_THROW(f1 = PLS::TaskFactory::startAsyncTask(lambdaFunction, pipeIn, pipeOut));
    ASSERT_NO_THROW(f2 = PLS::TaskFactory::startAsyncTask(lambdaFunction, pipeIn, pipeOut));
    ASSERT_NO_THROW(f3 = PLS::TaskFactory::startAsyncTask(lambdaFunction, pipeIn, pipeOut));
...
TEST(TaskFactoryTestWaitAll, wait_different_tasks)
{
    ...
    ASSERT_NO_THROW(fPipe  = PLS::TaskFactory::startAsyncTask(lambdaFunction, pipeIn, pipeOut));
